...
Locator: locator('[data-test="cart-item"]').filter({ has: locator('[data-test="inventory-item-name"]').filter({ hasText: 'Sauce Labs Backpack' }) })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-test="cart-item"]').filter({ has: locator('[data-test="inventory-item-name"]').filter({ hasText: 'Sauce Labs Backpack' }) })
